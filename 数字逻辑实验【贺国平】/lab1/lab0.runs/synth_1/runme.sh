...
HD_PWD='D:/========课程类/软件工程/Digital Logic/lab0/lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ml505top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ml505top.tcl
