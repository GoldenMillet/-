...
HD_PWD='D:/fpga_labs_sp18/lab0/lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ml505top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ml505top.tcl -notrace
